...
#' @references Huijuan Zhou, Jun Chen, and Xianyang Zhang. BMDD: A probabilistic framework for accurate imputation of zero-inflated microbiome sequencing data.
#' @examples
#'
...
bmdd <- function(W, type = c('count', 'proportion'),
